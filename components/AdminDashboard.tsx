...
export default function AdminDashboard({ nickname }: Props) {
                ...
                <tr key={user.id} className="border-b border-border text-text">
                  ...
                  <td className="py-2 pr-2">
                    <button
                      ...
                      className="rounded-md border border-border px-3 py-1 text-xs font-medium text-text-soft transition-colors hover:bg-primary-light disabled:opacity-50"
                    >
                      비밀번호 초기화
                    </button>
                  </td>
